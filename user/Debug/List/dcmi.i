#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\dcmi.c"
#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\dcmi.h"
...
#line 4 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\dcmi.h"
...
#line 2 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\dcmi.c"
#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\user\\..\\drivers\\bsp_ili9341.h"



#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\sys.h"
...
#line 21 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\sys.h"

#line 31 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\sys.h"
...
#line 5 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\user\\..\\drivers\\bsp_ili9341.h"
...
#line 3 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\dcmi.c"
...
#line 4 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\dcmi.c"
#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\user\\..\\app\\user_Debug_Info.h"



void usr_showstr(unsigned int y,const char *format,...);
void usr_Debug(const char *format,...);
#line 5 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\dcmi.c"
#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\user\\..\\app\\user_imgprocess.h"
...
#line 5 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\user\\..\\app\\user_imgprocess.h"
...
#line 6 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\sys\\dcmi.c"
...
{
	if(DCMI_GetITStatus(((uint16_t)0x0001))==SET)
	{
		jpeg_data_process(); 	
...
void dcmi_init(void)
{
    ...
    RCC_AHB1PeriphClockCmd(((uint32_t)0x00000001)|((uint32_t)0x00000002)|((uint32_t)0x00000004)|((uint32_t)0x00000010), ENABLE);
	RCC_AHB2PeriphClockCmd(((uint32_t)0x00000001),ENABLE);
    
    GPIO_InitStructure.GPIO_Pin   = ((uint16_t)0x0010)|((uint16_t)0x0040);
	...
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)),((uint8_t)0x05),((uint8_t)0x0D)); 
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)),((uint8_t)0x06),((uint8_t)0x0D)); 
    
    DCMI_DeInit();
    
    DCMI_InitStructure.DCMI_CaptureMode=((uint16_t)0x0000);    
...
{ 
    ...
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)&((DCMI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x50000))->DR;
    ...
    {
		DMA_DoubleBufferModeCmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)),ENABLE);
        DMA_MemoryTargetConfig(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)),DMA_Memory1BaseAddr,((uint32_t)0x00080000));
...
{        
	if(DMA_GetFlagStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)),((uint32_t)0x10000800))==SET)
	{  
	 DMA_ClearFlag(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)),((uint32_t)0x10000800));
     dcmi_rx_callback();	
	}    											 
} 
...
{ 
	...
	while(((DCMI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x50000))->CR&0X01);		
