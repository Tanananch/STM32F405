#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
#line 30 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
#line 38 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
#line 39 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
#line 40 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\user\\..\\FreeRTOS\\include\\event_groups.h"
...
#line 41 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
#line 62 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
#line 141 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
#line 177 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
	...
	if( ( ( uxBitsToWaitFor & 0xff000000UL ) == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	if( ( uxBitsToWaitFor != 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
	...
	if( ( xEventGroup ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	if( ( ( uxBitsToWaitFor & 0xff000000UL ) == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	if( ( uxBitsToWaitFor != 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
...
EventBits_t uxReturn;
	...
	if( ( xEventGroup ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	if( ( ( uxBitsToClear & 0xff000000UL ) == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
...
#line 501 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
...
BaseType_t xMatchFound = ( ( BaseType_t ) 0 );
	...
	if( ( xEventGroup ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	if( ( ( uxBitsToSet & 0xff000000UL ) == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
...
const List_t *pxTasksWaitingForBits = &( pxEventBits->xTasksWaitingForBits );
	...
	vTaskSuspendAll();
	{
		...
		while( ( ( pxTasksWaitingForBits )->uxNumberOfItems ) > ( UBaseType_t ) 0 )
		{
			...
			if( ( pxTasksWaitingForBits->xListEnd . pxNext != ( const ListItem_t * ) &( pxTasksWaitingForBits->xListEnd ) ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
...
#line 650 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
	}
	( void ) xTaskResumeAll();
}
...
#line 719 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\event_groups.c"
