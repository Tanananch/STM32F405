#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.c"
#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.h"
...
#line 4 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.h"
...
#line 5 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.h"
...
#line 6 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.h"
...
#line 7 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.h"
...
#line 8 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.h"
...
#line 2 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.c"
...
#line 3 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.c"
...
#line 4 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\app\\usart_cmd.c"

RX_CMD_DATA_LinkedListDef RX_CMD_DATA_LinkedStruct_Array[10];
RX_CMD_DATA_LinkedListDef *RX_CMD_DATA_Structp = RX_CMD_DATA_LinkedStruct_Array;

static uint8_t Usart_Rx_CMD[50] = {0};
...
void usart1_linked_list_init(void)
{
	...
	for (i = 0; i < 10; i++)
	{
		...
		RX_CMD_DATA_LinkedStruct_Array[i].USART1_ISR_binarySemaphore = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );

		if (RX_CMD_DATA_LinkedStruct_Array[i].USART1_ISR_binarySemaphore != 0)
		{
			
		}
		RX_CMD_DATA_LinkedStruct_Array[i].next = &RX_CMD_DATA_LinkedStruct_Array[(i + 1) % 10];
	}
}
...
void USART1_IRQHandler(void) 
{
	...
	ulReturn = (__iar_builtin_rsr("BASEPRI")); { (__iar_builtin_wsr("BASEPRI", (( 5 << (8 - 4) )))); __iar_builtin_DSB(); __iar_builtin_ISB(); };
	if (USART_GetITStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), ((uint16_t)0x0525)) != RESET)
	{
		...
		else
		{
			if (Usart_Rx_CMD[usart1_rx_len - 1] == '\r')
			{
				...
				Usart_Rx_CMD[usart1_rx_len - 1] = 0x00; 
				...
				{
					xQueueGiveFromISR( ( QueueHandle_t ) ( RX_CMD_DATA_Structp->USART1_ISR_binarySemaphore ), ( &xHigherPriorityTaskWoken ) );
	...
	(__iar_builtin_wsr("BASEPRI", (ulReturn)));
}
