#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\Libraries\\STM32F4xx_StdPeriph_Driver\\src\\stm32f4xx_hash_sha1.c"
...
#line 248 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\Libraries\\STM32F4xx_StdPeriph_Driver\\inc\\stm32f4xx_hash.h"
...
#line 39 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\user\\..\\Libraries\\STM32F4xx_StdPeriph_Driver\\inc\\stm32f4xx_hash.h"
...
#line 48 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\Libraries\\STM32F4xx_StdPeriph_Driver\\src\\stm32f4xx_hash_sha1.c"
...
ErrorStatus HASH_SHA1(uint8_t *Input, uint32_t Ilen, uint8_t Output[20])
{
  ...
  else
  {
    ...
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(SHA1_MessageDigest.Data[0]);
    outputaddr+=4;
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(SHA1_MessageDigest.Data[1]);
    outputaddr+=4;
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(SHA1_MessageDigest.Data[2]);
    outputaddr+=4;
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(SHA1_MessageDigest.Data[3]);
    outputaddr+=4;
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(SHA1_MessageDigest.Data[4]);
  }
  return status;
}
