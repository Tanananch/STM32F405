#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\Libraries\\STM32F4xx_StdPeriph_Driver\\src\\stm32f4xx_cryp_aes.c"
...
#line 375 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\Libraries\\STM32F4xx_StdPeriph_Driver\\inc\\stm32f4xx_cryp.h"
...
#line 39 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\user\\..\\Libraries\\STM32F4xx_StdPeriph_Driver\\inc\\stm32f4xx_cryp.h"
...
#line 56 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\Libraries\\STM32F4xx_StdPeriph_Driver\\src\\stm32f4xx_cryp_aes.c"
                         ...
                         uint8_t* Input, uint32_t Ilength, uint8_t* Output)
{
  ...
  switch(Keysize)
  {
    ...
    AES_CRYP_KeyInitStructure.CRYP_Key2Left = __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key2Right= __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key3Left = __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key3Right= __iar_builtin_REV(*(uint32_t*)(keyaddr));
    break;
    case 192:
    AES_CRYP_InitStructure.CRYP_KeySize  = ((uint16_t)0x0100);
    AES_CRYP_KeyInitStructure.CRYP_Key1Left = __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key1Right= __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key2Left = __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key2Right= __iar_builtin_REV(*(uint32_t*)(keyaddr));
    ...
    AES_CRYP_KeyInitStructure.CRYP_Key0Left = __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key0Right= __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key1Left = __iar_builtin_REV(*(uint32_t*)(keyaddr));
    keyaddr+=4;
    AES_CRYP_KeyInitStructure.CRYP_Key1Right= __iar_builtin_REV(*(uint32_t*)(keyaddr));
                         ...
                         uint8_t *Output)
{
  ...
  AES_CRYP_IVInitStructure.CRYP_IV0Left = __iar_builtin_REV(*(uint32_t*)(ivaddr));
  ivaddr+=4;
  AES_CRYP_IVInitStructure.CRYP_IV0Right= __iar_builtin_REV(*(uint32_t*)(ivaddr));
  ivaddr+=4;
  AES_CRYP_IVInitStructure.CRYP_IV1Left = __iar_builtin_REV(*(uint32_t*)(ivaddr));
  ivaddr+=4;
  AES_CRYP_IVInitStructure.CRYP_IV1Right= __iar_builtin_REV(*(uint32_t*)(ivaddr));
                         ...
                         uint8_t *Output, uint8_t *AuthTAG)
{
  ...
  if(Mode == ((uint8_t)0x01))  
  {
    ...
    CRYP_DataIn(__iar_builtin_REV(headerlength>>32));
    CRYP_DataIn(__iar_builtin_REV(headerlength));
    CRYP_DataIn(__iar_builtin_REV(inputlength>>32));
    CRYP_DataIn(__iar_builtin_REV(inputlength));
                         ...
                         uint8_t *AuthTAG, uint32_t TAGSize)
{
  ...
  AES_CRYP_IVInitStructure.CRYP_IV0Left = (__iar_builtin_REV(*(uint32_t*)(ctraddr)));
  ctraddr+=4;
  AES_CRYP_IVInitStructure.CRYP_IV0Right= (__iar_builtin_REV(*(uint32_t*)(ctraddr)));
  ctraddr+=4;
  AES_CRYP_IVInitStructure.CRYP_IV1Left = (__iar_builtin_REV(*(uint32_t*)(ctraddr)));
  ctraddr+=4;
  AES_CRYP_IVInitStructure.CRYP_IV1Right= (__iar_builtin_REV(*(uint32_t*)(ctraddr)));
