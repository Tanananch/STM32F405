#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\MemMang\\heap_4.c"
...
#line 37 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\MemMang\\heap_4.c"
...
#line 44 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\MemMang\\heap_4.c"
...
#line 45 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\MemMang\\heap_4.c"
		...
		if( ( xWantedSize & xBlockAllocatedBit ) == 0 )
		{
			...
			if( xWantedSize > 0 )
			{
				...
				if( ( xWantedSize & ( 0x0007 ) ) != 0x00 )
				{
					...
					if( ( ( xWantedSize & ( 0x0007 ) ) == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
				}
				else
				{
					;
			...
			if( ( xWantedSize > 0 ) && ( xWantedSize <= xFreeBytesRemaining ) )
			{
				...
				if( pxBlock != pxEnd )
				{
					...
					if( ( pxBlock->xBlockSize - xWantedSize ) > ( ( size_t ) ( xHeapStructSize << 1 ) ) )
					{
						...
						if( ( ( ( ( size_t ) pxNewBlockLink ) & ( 0x0007 ) ) == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
...
#line 260 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\MemMang\\heap_4.c"

	if( ( ( ( ( size_t ) pvReturn ) & ( size_t ) ( 0x0007 ) ) == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	return pvReturn;
}
...
BlockLink_t *pxLink;
	...
	if( pv != 0 )
	{
		...
		if( ( ( pxLink->xBlockSize & xBlockAllocatedBit ) != 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
		if( ( pxLink->pxNextFreeBlock == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
