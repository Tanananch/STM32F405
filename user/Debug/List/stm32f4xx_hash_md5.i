#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\Libraries\\STM32F4xx_StdPeriph_Driver\\src\\stm32f4xx_hash_md5.c"
...
#line 48 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\Libraries\\STM32F4xx_StdPeriph_Driver\\src\\stm32f4xx_hash_md5.c"
...
ErrorStatus HASH_MD5(uint8_t *Input, uint32_t Ilen, uint8_t Output[16])
{
  ...
  else
  {
    ...
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(MD5_MessageDigest.Data[0]);
    outputaddr+=4;
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(MD5_MessageDigest.Data[1]);
    outputaddr+=4;
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(MD5_MessageDigest.Data[2]);
    outputaddr+=4;
    *(uint32_t*)(outputaddr)  = __iar_builtin_REV(MD5_MessageDigest.Data[3]);
  }
  return status; 
}
