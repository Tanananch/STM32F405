#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
...
#line 15 "E:\\IAR Systems\\Embedded Workbench 8.3\\arm\\inc\\c\\iccarm_builtin.h"
...
#line 34 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
...
#line 1 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\portmacro.h"
...
#line 56 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\portmacro.h"
...
#line 94 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\portmacro.h"
...
#line 135 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\portmacro.h"
...
#line 37 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
...
#line 38 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
...
#line 56 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
...
#line 87 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
...
static void prvTaskExitError( void )
{
	...
	if( ( uxCriticalNesting == ~0UL ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
...
BaseType_t xPortStartScheduler( void )
{
	...
	if( ( ( 5 << (8 - 4) ) ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };

	

 
	if( ( ( * ( ( volatile uint32_t * ) 0xE000ed00 ) ) != ( 0x410FC271UL ) ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	if( ( ( * ( ( volatile uint32_t * ) 0xE000ed00 ) ) != ( 0x410FC270UL ) ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
...
#line 283 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
...

		{
			...
			if( ( ( ( ( uint8_t ) 7 ) - ulMaxPRIGROUPValue ) == 4 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
		}
...
void vPortEndScheduler( void )
{
	...
	if( ( uxCriticalNesting == 1000UL ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
}
...
void vPortEnterCritical( void )
{
	...
	{
		if( ( ( ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) & ( 0xFFUL ) ) == 0 ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	}
}
...
{
	if( ( uxCriticalNesting ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	uxCriticalNesting--;
...
#line 550 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
...
#line 566 "D:\\practice\\Iar\\IARforSTM32\\10-ov2940\\FreeRTOS\\portable\\IAR\\ARM_CM4F\\port.c"
	...
	uint8_t ucCurrentPriority;
		...
		if( ulCurrentInterrupt >= ( 16 ) )
		{
			...
			if( ( ucCurrentPriority >= ucMaxSysCallPriority ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
		}
		...
		if( ( ( ( * ( ( volatile uint32_t * ) 0xE000ED0C ) ) & ( 0x07UL << 8UL ) ) <= ulMaxPRIGROUPValue ) == 0 ) { { __iar_builtin_set_BASEPRI( ( 5 << (8 - 4) ) ); __iar_builtin_DSBx(15); __iar_builtin_ISBx(15); }; for( ;; ); };
	}
